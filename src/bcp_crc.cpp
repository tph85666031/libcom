...
uint8 bcp_crc8(uint8* data, int data_size, uint8 init_val)
{
...
uint16 bcp_crc16(uint8* data, int data_size, uint16 init_val)
{
    if (data == NULL || data_size <= 0)
    {
        return 0;
...
uint32 bcp_crc32(uint8* data, int data_size, uint32 init_val)
{
    if (data == NULL || data_size <= 0)
    {
        return 0;
...
uint64 bcp_crc64(uint8* data, int data_size, uint64 init_val)
{
    if (data == NULL || data_size <= 0)
    {
        return 0;
