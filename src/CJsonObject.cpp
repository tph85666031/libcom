...
void CJsonObject::EnableEmptyString()
{
    cJSON_EnableEmptyString();
}

void CJsonObject::DisableEmptyString()
{
    cJSON_DisableEmptyString();
}
...
bool CJsonObject::Parse(const char* strJson)
{
    if(strJson == NULL)
    {
        return false;
...
bool CJsonObject::Get(const std::string& strKey, int8& iValue) const
{
    int32 value = 0;
    bool ret = Get(strKey, value);
    iValue = (int8)value;
...
bool CJsonObject::Get(const std::string& strKey, uint8& uiValue) const
{
    uint32 value = 0;
    bool ret = Get(strKey, value);
    uiValue = (uint8)value;
...
bool CJsonObject::Get(const std::string& strKey, bool& bValue) const
{
    ...
    {
        std::string val = pJsonStruct->valuestring;
...
{
    return Add(strKey, (int32)cValue);
}

bool CJsonObject::Add(const std::string& strKey, int8 iValue)
{
    return Add(strKey, (int32)iValue);
}

bool CJsonObject::Add(const std::string& strKey, uint8 uiValue)
{
    return Add(strKey, (uint32)uiValue);
}
...
bool CJsonObject::Replace(const std::string& strKey, const char* strValue)
{
    if(strValue == NULL)
    {
        return false;
...
{
    return Add(strValue.c_str());
}

bool CJsonObject::Add(const char* strValue)
{
    if(strValue == NULL)
    {
        return false;
