...
int8 com_mem_get_int8(const char* key, int8 default_val = 0);
int16 com_mem_get_int16(const char* key, int16 default_val = 0);
int32 com_mem_get_int32(const char* key, int32 default_val = 0);
int64 com_mem_get_int64(const char* key, int64 default_val = 0);
uint8 com_mem_get_uint8(const char* key, uint8 default_val = 0);
uint16 com_mem_get_uint16(const char* key, uint16 default_val = 0);
uint32 com_mem_get_uint32(const char* key, uint32 default_val = 0);
uint64 com_mem_get_uint64(const char* key, uint64 default_val = 0);
