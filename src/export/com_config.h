...
public:
    ...
    int8_t getInt8(const char* group, const char* key, int8_t default_val = 0);
    uint8_t getUInt8(const char* group, const char* key, uint8_t default_val = 0);
    int16_t getInt16(const char* group, const char* key, int16_t default_val = 0);
    uint16_t getUInt16(const char* group, const char* key, uint16_t default_val = 0);
    int32_t getInt32(const char* group, const char* key, int32_t default_val = 0);
    uint32_t getUInt32(const char* group, const char* key, uint32_t default_val = 0);
    int64_t getInt64(const char* group, const char* key, int64_t default_val = 0);
	uint64_t getUInt64(const char* group, const char* key, uint64_t default_val = 0);
...
int8_t com_global_config_get_int8(const char* group, const char* key, int8_t default_val = 0);
int16_t com_global_config_get_int16(const char* group, const char* key, int16_t default_val = 0);
int32_t com_global_config_get_int32(const char* group, const char* key, int32_t default_val = 0);
int64_t com_global_config_get_int64(const char* group, const char* key, int64_t default_val = 0);
uint8_t com_global_config_get_uint8(const char* group, const char* key, uint8_t default_val = 0);
uint16_t com_global_config_get_uint16(const char* group, const char* key, uint16_t default_val = 0);
uint32_t com_global_config_get_uint32(const char* group, const char* key, uint32_t default_val = 0);
uint64_t com_global_config_get_uint64(const char* group, const char* key, uint64_t default_val = 0);
