...
COM_EXPORT bool com_file_clear(const char* file_path);
COM_EXPORT bool com_file_clear(FILE* file);
COM_EXPORT ComBytes com_file_read(const char* file, int size, int64 offset = -1);
COM_EXPORT ComBytes com_file_read(FILE* file, int size);
COM_EXPORT ComBytes com_file_read(int fd, int size);
COM_EXPORT int64 com_file_read(FILE* file, void* buf, int64 size);
COM_EXPORT int64 com_file_read(int fd, void* buf, int64 size);
COM_EXPORT ComBytes com_file_read_until(FILE* file, const char* str);
COM_EXPORT ComBytes com_file_read_until(FILE* file, const uint8* data, int data_size);
COM_EXPORT ComBytes com_file_read_until(FILE* file, std::function<bool(uint8)> func);
COM_EXPORT int64 com_file_find(const char* file, const char* key, int64 offset = -1);
COM_EXPORT int64 com_file_find(const char* file, const uint8* key, int key_size, int64 offset = -1);
...
COM_EXPORT int64 com_file_rfind(const char* file, const char* key, int64 offset = -1);
COM_EXPORT int64 com_file_rfind(const char* file, const uint8* key, int key_size, int64 offset = -1);
...
COM_EXPORT ComBytes com_file_readall(const std::string& file_path, int64 offset = -1);
COM_EXPORT ComBytes com_file_readall(const char* file_path, int64 offset = -1);
COM_EXPORT ComBytes com_file_readall(int fd, int64 offset = -1);
...
COM_EXPORT bool com_file_seek_to_head(FILE* file);
COM_EXPORT bool com_file_seek_to_head(int fd);
COM_EXPORT bool com_file_seek_to_tail(FILE* file);
COM_EXPORT bool com_file_seek_to_tail(int fd);
COM_EXPORT bool com_file_seek_step(FILE* file, int64 pos);
COM_EXPORT bool com_file_seek_step(int fd, int64 pos);
COM_EXPORT bool com_file_seek_from_head(FILE* file, int64 pos);
COM_EXPORT bool com_file_seek_from_head(int fd, int64 pos);
COM_EXPORT bool com_file_seek_from_tail(FILE* file, int64 pos);
COM_EXPORT bool com_file_seek_from_tail(int fd, int64 pos);
COM_EXPORT int64 com_file_seek_get(FILE* file);
COM_EXPORT int64 com_file_seek_get(int fd);
COM_EXPORT bool com_file_seek(FILE* file, int64 pos, int whence);
COM_EXPORT bool com_file_seek(int fd, int64 pos, int whence);
