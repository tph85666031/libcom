...
COM_EXPORT CPPBytes com_file_read(const char* file, int size, int64 offset = -1);
COM_EXPORT CPPBytes com_file_read(FILE* file, int size);
COM_EXPORT CPPBytes com_file_read(int fd, int size);
...
COM_EXPORT CPPBytes com_file_readall(const std::string& file_path, int64 offset = -1);
COM_EXPORT CPPBytes com_file_readall(const char* file_path, int64 offset = -1);
COM_EXPORT CPPBytes com_file_readall(int fd, int64 offset = -1);
