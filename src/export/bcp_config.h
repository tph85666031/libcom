...
bool bcp_global_config_load(const char* config_file, bool safe_mode = true, const char* safe_dir = NULL);
...
bool bcp_global_config_get_bool(const char* group, const char* key, bool default_val = false);
double bcp_global_config_get_double(const char* group, const char* key, double default_val = 0.0f);
int8 bcp_global_config_get_int8(const char* group, const char* key, int8 default_val = 0);
int16 bcp_global_config_get_int16(const char* group, const char* key, int16 default_val = 0);
int32 bcp_global_config_get_int32(const char* group, const char* key, int32 default_val = 0);
int64 bcp_global_config_get_int64(const char* group, const char* key, int64 default_val = 0);
uint8 bcp_global_config_get_uint8(const char* group, const char* key, uint8 default_val = 0);
uint16 bcp_global_config_get_uint16(const char* group, const char* key, uint16 default_val = 0);
uint32 bcp_global_config_get_uint32(const char* group, const char* key, uint32 default_val = 0);
uint64 bcp_global_config_get_uint64(const char* group, const char* key, uint64 default_val = 0);
std::string bcp_global_config_get_string(const char* group, const char* key, std::string default_val = std::string());
