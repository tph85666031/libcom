...
int bcp_socket_udp_open(const char* interface_name, uint16 recv_port, bool broadcast = false);
int bcp_socket_tcp_open(const char* remote_host, uint16 remote_port,
                        uint32 timeout_ms = 10000, const char* interface_name = NULL);
int bcp_socket_udp_send(int socketfd, const char* dest_host, int dest_port,
